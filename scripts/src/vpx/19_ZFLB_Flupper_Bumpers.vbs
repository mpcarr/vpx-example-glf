...
' Sub SetFlBumperDN 'call from Table1_OptionEvent
'     If NightDay < 10 Then
'         DNA30 = 0
...
Sub FlInitBumper(nr, col)
    ...
    Set Flbumperbiglight(nr) = Eval("BL" & nr)
    Set FlBumperSmallLight(nr) = Eval("BL" & nr & "a")
    Set FlBumperHighlight(nr) = Eval("f_bumperhighlight_BL" & nr & "_")
	Set FlBumperTop(nr) = Eval("p_bumpertop_BL" & nr)
	FlBumperTop(nr).material = "bumpertopmat" & nr
	Set FlBumperDisk(nr) = Eval("p_bumperdisk_BL" & nr)
	Set FlBumperBase(nr) = Eval("p_bumperbase_BL" & nr)
	Set FlBumperBulb(nr) = Eval("p_bumperbulb_BL" & nr & "_")  'additive prim. follows light color
	FlBumperBulb(nr).material = "bumperbulbmat" & nr
	Set FlBumperscrews(nr) = Eval("p_bumperscrews_BL" & nr)
	FlBumperscrews(nr).material = "bumpermetal"
	...
	Select Case col
		Case "red"
            ...
            FlBumperTop(nr).BlendDisableLighting = 3*NightDay/100
            FlBumperHighlight(nr).opacity = 2000
            UpdateMaterial "bumperbulbmat" & nr, 0, 0.75 , 0, 1, 1, 1, 0.9999, RGB(255, 16, 0), RGB(255,255,255), RGB(32,32,32), False, True, 0, 0, 0, 0
            MaterialColor "bumpertopmat" & nr, RGB(255,20,8)
		...
		Case "blue"
            ...
            FlBumperTop(nr).BlendDisableLighting = 3*NightDay/100
            FlBumperHighlight(nr).opacity = 10000
            UpdateMaterial "bumperbulbmat" & nr, 0, 0.75 , 0, 1, 1, 1, 0.9999, RGB(38,130,255), RGB(255,255,255), RGB(32,32,32), False, True, 0, 0, 0, 0
		...
		Case "green"
			...
			FlBumperSmallLight(nr).BulbModulateVsAdd = 1
            FlBumperTop(nr).BlendDisableLighting = 3*NightDay/100
            FlBumperHighlight(nr).opacity = 6000
            UpdateMaterial "bumperbulbmat" & nr, 0, 0.75 , 0, 1, 1, 1, 0.9999, RGB(16,255,16), RGB(255,255,255), RGB(32,32,32), False, True, 0, 0, 0, 0
		...
		Case "orange"
            ...
            FlBumperTop(nr).BlendDisableLighting = 3*NightDay/100
            FlBumperHighlight(nr).opacity = 4000
            UpdateMaterial "bumperbulbmat" & nr, 0, 0.75 , 0, 1, 1, 1, 0.9999, RGB(255, 100,0), RGB(255,255,255), RGB(32,32,32), False, True, 0, 0, 0, 0
            MaterialColor "bumpertopmat" & nr, RGB(255,100, 0)
		...
		Case "white"
            ...
            FlBumperSmallLight(nr).color = RGB(255,255,255)
            FlBumperSmallLight(nr).colorfull = RGB(255,255,255)
			FlBumperSmallLight(nr).TransmissionScale = 0
			FlBumperSmallLight(nr).BulbModulateVsAdd = 0.99
            FlBumperTop(nr).BlendDisableLighting = 5*NightDay/100
            FlBumperHighlight(nr).opacity = 1000
            UpdateMaterial "bumperbulbmat" & nr, 0, 0.75 , 0, 1, 1, 1, 0.9999, RGB(255, 230, 200), RGB(255,255,255), RGB(32,32,32), False, True, 0, 0, 0, 0
		...
		Case "blacklight"
            ...
            FlBumperTop(nr).BlendDisableLighting = 3*NightDay/100
            FlBumperHighlight(nr).opacity = 2000
            UpdateMaterial "bumperbulbmat" & nr, 0, 0.75 , 0, 1, 1, 1, 1, RGB(30, 30, 255), RGB(255,255,255), RGB(32,32,32), False, True, 0, 0, 0, 0
            MaterialColor "bumpertopmat" & nr, RGB(255,235,220)
		...
		Case "yellow"
			...
			FlBumperSmallLight(nr).TransmissionScale = 0
            FlBumperTop(nr).BlendDisableLighting = 3*NightDay/100
            UpdateMaterial "bumperbulbmat" & nr, 0, 0.75 , 0, 1, 1, 1, 0.9999, RGB(255, 180, 0), RGB(255,255,255), RGB(32,32,32), False, True, 0, 0, 0, 0
            MaterialColor "bumpertopmat" & nr, RGB(255, 200, 24)
		...
		Case "purple"
            ...
            FlBumperTop(nr).BlendDisableLighting = 3*NightDay/100
            FlBumperHighlight(nr).opacity = 4000
            UpdateMaterial "bumperbulbmat" & nr, 0, 0.75 , 0, 1, 1, 1, 0.9999, RGB(128, 32, 255), RGB(255,255,255), RGB(32,32,32), False, True, 0, 0, 0, 0
            MaterialColor "bumpertopmat" & nr, RGB(128,32,255)
	End Select
End Sub
