...
'     Set FlBumperSmallLight(nr) = Eval("BL" & nr)
'     Set Flbumperbiglight(nr) = Eval("BL" & nr & "a")
'     'Set FlBumperHighlight(nr) = Eval("BL" & nr & "b")
' 	Set FlBumperTop(nr) = Eval("p_bumpertop" & nr)
' 	FlBumperTop(nr).material = "bumpertopmat" & nr
' 	Set FlBumperDisk(nr) = Eval("p_bumperdisk" & nr)
' 	Set FlBumperBase(nr) = Eval("p_bumperbase" & nr)
' 	Set FlBumperBulb(nr) = Eval("p_bumperbulb" & nr & "_")  'additive prim. follows light color
' 	FlBumperBulb(nr).material = "bumperbulbmat" & nr
' 	Set FlBumperscrews(nr) = Eval("p_bumperscrews" & nr)
