...
'******************************************************
'  ZDRT : Roth Drop Targets
'******************************************************
' Documentation: https://mpcarr.github.io/vpx-glf/drop-target/
' NOTE: Be sure to include all the drop target main hit walls in the "glf_droptargets" collection


' ROTH DROP TARGETS INITIALIZATION
...
' Case 1 - Drop target is being hit
' Case 2 - Unused
' Case 3 - Enable Keep up, i.e. prevent roth drop from dropping when a ball hits
